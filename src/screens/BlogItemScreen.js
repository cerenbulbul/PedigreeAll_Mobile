        ...
        <View style={styles.Container}>
            ...
            <ScrollView>
                ...
                {selectedBlog !== undefined && 
                    <View>
                      <Card containerStyle={{elevation:0,borderWidth:0,borderRadius:10,padding:10}}>
                        ...
                        <Card.Image 
                          style={{borderRadius:3,resizeMode:'contain',height:300}}
                          source={{uri:'https://www.pedigreeall.com/blog/' + selectedBlog.IMAGE}} />
                        
                      <Card.Divider/>
                        <HTML source={{ html: selectedBlog.BLOG_EN }} />
